...
/**
 * DayBotChat — Pluggable React Chatbot Component
 * 
 * Props:
 * - role: "employee" | "admin" (default: "employee")
 * - employeeId: string (default: "EMP001")
 * - apiUrl: string (default: "http://localhost:3000")
 * - customContext: string (optional dynamic data to pass to Gemini)
 */
export default function DayBotChat({ 
  role = "employee", 
  employeeId = "EMP001", 
